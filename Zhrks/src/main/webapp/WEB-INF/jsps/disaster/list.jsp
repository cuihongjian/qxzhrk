	...
	<div class="modal fade" id="uploadVideo" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
	  	<div class="modal-dialog modal-dialog-centered" role="document">
	    	<div class="modal-content">
			     ...
			     <form class="registerform am-form" id="uploadViewForm" action="" method="post">
		      	    <div class="modal-body text-center">
						<div class="form-group row">
				...
				if(ret.state == "ok"){
					...
					for(var i = 0 ;i < data.length;i++){
						...
						for(var j = 0;j<videos.length;j++){
							...
							html = html + "value=\""+path+"\"><label class=\"custom-control-label\" for=\""+videos[j].ID+"\">"+videoName+"</label></div>";
							if(j%2!=0){
								html = html + "</div>";
							}
						}
